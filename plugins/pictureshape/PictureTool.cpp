...
QWidget *PictureTool::createOptionWidget()
{
    ...
    m_pictureToolUI->cmbColorMode->addItem(QObject::tr("Standard")  , PictureShape::Standard);
    m_pictureToolUI->cmbColorMode->addItem(QObject::tr("Greyscale") , PictureShape::Greyscale);
    m_pictureToolUI->cmbColorMode->addItem(QObject::tr("Monochrome"), PictureShape::Mono);
    m_pictureToolUI->cmbColorMode->addItem(QObject::tr("Watermark") , PictureShape::Watermark);
...
void PictureTool::setImageData(const QImage &image)
{
    if (m_pictureshape == 0)
