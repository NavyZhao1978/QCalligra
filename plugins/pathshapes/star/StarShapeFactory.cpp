...
StarShapeFactory::StarShapeFactory()
    : KoShapeFactoryBase(StarShapeId, QObject::tr("A star shape"))
{
    setToolTip(QObject::tr("A star"));
    ...
    t.id = KoPathShapeId;
    t.templateId = "star";
    t.name = QObject::tr("Star");
    t.family = "geometric";
    t.toolTip = QObject::tr("A star");
    ...
    t.id = KoPathShapeId;
    t.templateId = "flower";
    t.name = QObject::tr("Flower");
    t.family = "funny";
    t.toolTip = QObject::tr("A flower");
    ...
    t.name = QObject::tr("Pentagon");
    t.family = "geometric";
    t.toolTip = QObject::tr("A pentagon");
    ...
    t.name = QObject::tr("Hexagon");
    t.family = "geometric";
    t.toolTip = QObject::tr("A hexagon");
