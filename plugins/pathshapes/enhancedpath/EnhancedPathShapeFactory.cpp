...
EnhancedPathShapeFactory::EnhancedPathShapeFactory()
    : KoShapeFactoryBase(EnhancedPathShapeId, QObject::tr("An enhanced path shape"))
{
    setToolTip(QObject::tr("An enhanced path"));
...
void EnhancedPathShapeFactory::addCross()
{
    ...
    t.id = KoPathShapeId;
    t.templateId = "cross";
    t.name = QObject::tr("Cross");
    t.family = "funny";
    t.toolTip = QObject::tr("A cross");
...
void EnhancedPathShapeFactory::addArrow()
{
    { // arrow right
        ...
        t.name = QObject::tr("Arrow");
        t.family = "arrow";
        t.toolTip = QObject::tr("An arrow");
...
void EnhancedPathShapeFactory::addCallout()
{
    ...
    t.name = QObject::tr("Callout");
    t.family = "funny";
    t.toolTip = QObject::tr("A callout");
...
void EnhancedPathShapeFactory::addSmiley()
{
    ...
    t.id = KoPathShapeId;
    t.templateId = "smiley";
    t.name = QObject::tr("Smiley");
    t.family = "funny";
    t.toolTip = QObject::tr("Smiley");
...
void EnhancedPathShapeFactory::addCircularArrow()
{
    ...
    t.name = QObject::tr("Circular Arrow");
    t.family = "arrow";
    t.toolTip = QObject::tr("A circular-arrow");
...
void EnhancedPathShapeFactory::addGearhead()
{
    ...
    t.name = QObject::tr("Gearhead");
    t.family = "funny";
    t.toolTip = QObject::tr("A gearhead");
