...
ArtisticTextShapeFactory::ArtisticTextShapeFactory()
    : KoShapeFactoryBase(ArtisticTextShapeID, QObject::tr("ArtisticTextShape"))
{
    setToolTip(QObject::tr("A shape which shows a single text line"));
...
KoShape *ArtisticTextShapeFactory::createDefaultShape(KoDocumentResourceManager *) const
{
    ...
    text->setPlainText(QObject::tr("Artistic Text"));
    return text;
}
