...
void ShapeCollectionDocker::loadDefaultShapes()
{
	...
	cfg.beginGroup("KoShapeCollection");
    quickShapes += cfg.value("QuickShapes").toStringList();
	cfg.endGroup();
    ...
    addCollection("default", QObject::tr("Default"), model);

    model = new CollectionItemModel(this);
    model->setShapeTemplateList(geometricList);
    addCollection("geometric", QObject::tr("Geometrics"), model);

    model = new CollectionItemModel(this);
    model->setShapeTemplateList(arrowList);
    addCollection("arrow", QObject::tr("Arrows"), model);

    model = new CollectionItemModel(this);
    model->setShapeTemplateList(funnyList);
    addCollection("funny", QObject::tr("Funny"), model);
...
void ShapeCollectionDocker::scanCollectionDir(const QString& path, QMenu* menu)
{
	...
	QSettings dg(dir.absoluteFilePath(".directory"), QSettings::IniFormat); 
	dg.beginGroup("Desktop Entry");
    QString name = dg.value("Name").toString();
    QString icon = dg.value("Icon").toString();
...
void ShapeCollectionDocker::onLoadingFailed(const QString& reason)
{
    ...
    QMessageBox::critical (this, reason, QObject::tr("Collection Error"));
}
