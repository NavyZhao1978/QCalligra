    ...
    m_guideLine(new GuideLine())
{
	...
	rotatePixmap.load( QCoreApplication::applicationDirPath()+"/data"+"/calligra/icons/rotate.png" );
    //shearPixmap.load(KStandardDirs::locate("data", "calligra/icons/shear.png"));
	shearPixmap.load( QCoreApplication::applicationDirPath()+"/data"+"calligra/icons/shear.png" );
...
*/
    ...
    m_sizeCursors[0] = QCursor(Qt::SizeVerCursor);
    m_sizeCursors[1] = QCursor(Qt::SizeBDiagCursor);
    m_sizeCursors[2] = QCursor(Qt::SizeHorCursor);
    m_sizeCursors[3] = QCursor(Qt::SizeFDiagCursor);
    m_sizeCursors[4] = QCursor(Qt::SizeVerCursor);
    m_sizeCursors[5] = QCursor(Qt::SizeBDiagCursor);
    m_sizeCursors[6] = QCursor(Qt::SizeHorCursor);
    m_sizeCursors[7] = QCursor(Qt::SizeFDiagCursor);
...
void DefaultTool::setupActions()
{
    QAction* actionBringToFront = new QAction(koIcon("object-order-front-calligra"),
                                               QObject::tr("Bring to &Front"), this);
    ...
    QAction* actionRaise = new QAction(koIcon("object-order-raise-calligra"), QObject::tr("&Raise"), this);
    ...
    QAction* actionLower = new QAction(koIcon("object-order-lower-calligra"), QObject::tr("&Lower"), this);
    ...
    QAction* actionAlignCenter = new QAction(koIcon("object-align-horizontal-center-calligra"),
                                              QObject::tr("Horizontally Center"), this);
    ...
    QAction* actionAlignTop = new QAction(koIcon("object-align-vertical-top-calligra"), QObject::tr("Align Top"), this);
    ...
    QAction* actionAlignMiddle = new QAction(koIcon("object-align-vertical-center-calligra"),
                                              QObject::tr("Vertically Center"), this);
        ...
        if (!m_mouseWasInsideHandles) {
            ...
            case KoFlake::NoHandle:
                if (m_guideLine->isValid()) {
                    ...
                    statusText = QObject::tr("Click and drag to move guide line.");
                }
                else
            ...
            if (rotateHandle)
                statusText = QObject::tr("Left click rotates around center, right click around highlighted position.");
            if (shearHandle)
                statusText = QObject::tr("Click and drag to shear selection.");
        }
        else {
            statusText = QObject::tr("Click and drag to resize selection.");
            ...
            case KoFlake::NoHandle:
                ...
                statusText = QObject::tr("Click and drag to move selection.");
                break;
            }
            if (cornerHandle)
                statusText = QObject::tr("Click and drag to resize selection. Middle click to set highlighted position.");
        }
        if (!editable)
...
void DefaultTool::selectionGroup()
{
    ...
    KUndo2Command *cmd = new KUndo2Command(QObject::tr("Group shapes"));
...
void DefaultTool::selectionUngroup()
{
    ...
    foreach(KoShape* shape, containerSet) {
        ...
        if (group) {
            cmd = cmd ? cmd : new KUndo2Command(QObject::tr("Ungroup shapes"));
