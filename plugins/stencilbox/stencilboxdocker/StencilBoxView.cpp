...
{
    QMenu menu;
    menu.addAction(QObject::tr("Expand all"), this, SLOT(expandAll()));
    menu.addAction(QObject::tr("Collapse all"), this, SLOT(collapseAll()));
    menu.addSeparator();

    QAction *listModeAction = menu.addAction(QObject::tr("List View"));
    QAction *iconModeAction = menu.addAction(QObject::tr("Icon View"));
