...
public:
     ...
     */
    KoRecentDocumentsPane(QWidget* parent, const QString &_componentData, const QString& header);
...
protected slots:
    ...
    void updatePreview(const QFileInfo& fileItem, const QPixmap& preview);
    void updateIcon(const QFileInfo& fileItem, const QPixmap& pixmap);
