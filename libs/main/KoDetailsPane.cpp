...
{
public:
    KoDetailsPanePrivate(const QString &componentData)
...
KoDetailsPane::KoDetailsPane(QWidget* parent, const QString &_componentData, const QString& header)
        : QWidget(parent),
...
QString KoDetailsPane::componentData()
{
