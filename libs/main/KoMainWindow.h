 ...
 */
class KOMAIN_EXPORT KoMainWindow : public QMainWindow, public KoCanvasSupervisor
{
    Q_OBJECT
public:
     ...
     */
    explicit KoMainWindow(const QString &instance);
     ...
     */
    bool openDocument(KoPart *newPart, KoDocument *newdoc, const QUrl & url);
...
private slots:
    ...
    void slotLoadCompleted(KoPart *part);
