...
void HorizontalPaintingStrategy::drawMeasurements(const KoRulerPrivate *d, QPainter &painter, const QRectF &rectangle)
{
    ...
    const QFont font = QApplication::font();	//KGlobalSettings::smallestReadableFont();
...
QSize HorizontalPaintingStrategy::sizeHint()
{
    ...
    const QFontMetrics fm(QApplication::font());	//(KGlobalSettings::smallestReadableFont());
...
void KoRuler::mouseMoveEvent ( QMouseEvent* ev )
{
    ...
    case KoRulerPrivate::None:
        ...
        QString text;
        switch(selection) {
        case KoRulerPrivate::FirstLineIndent: text = QObject::tr("First line indent"); break;
        case KoRulerPrivate::ParagraphIndent: text = QObject::tr("Left indent"); break;
        case KoRulerPrivate::EndIndent: text = QObject::tr("Right indent"); break;
        case KoRulerPrivate::None:
