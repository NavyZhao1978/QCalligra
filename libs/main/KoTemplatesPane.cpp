...
KoTemplatesPane::KoTemplatesPane(QWidget* parent, const QString &_componentData, const QString& header,
        ...
        , d(new KoTemplatesPanePrivate)
{
    ...
    //KGuiItem openGItem(QObject::tr("Use This Template"));
    //m_openButton->setGuiItem(openGItem
	m_openButton->setText(QObject::tr("Use This Template"));
