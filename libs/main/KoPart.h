...
public:
	...
	void setModified(bool mod=true) { m_bMod = mod; };
	bool isModified() { return m_bMod; };
...
//    using ReadWritePart::setLocalFilePath;
     ...
     * Constructor.
     *
     * @param parent may be another KoDocument
     */
    ...
    void addRecentURLToAllShells(QUrl url);
...
protected:
     ...
     * @param instance the QString to be used for KConfig data
     * @param templateType the template-type (group) that should be selected on creation.
     */
    KoOpenPane *createOpenPane(QWidget *parent, const QString &instance,
