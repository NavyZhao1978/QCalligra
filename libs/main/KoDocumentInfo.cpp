...
KoDocumentInfo::KoDocumentInfo(QObject *parent) : QObject(parent)
{
    ...
    setAboutInfo("initial-creator", QObject::tr("Unknown"));
...
void KoDocumentInfo::saveParameters()
{
    ...
    QString profile = appAuthorGroup.value("active-profile", "").toString();
	appAuthorGroup.endGroup();

    if (profiles.contains(profile)) {
        //KConfigGroup cgs(&authorGroup, "Author-" + profile);
		authorGroup.beginGroup("Author-" + profile);
        setAuthorInfo("creator", authorGroup.value("creator", "").toString());
        setAuthorInfo("initial", authorGroup.value("initial", "").toString());
        setAuthorInfo("author-title", authorGroup.value("author-title", "").toString());
        setAuthorInfo("email", authorGroup.value("email", "").toString());
        setAuthorInfo("telephone", authorGroup.value("telephone").toString());
        setAuthorInfo("telephone-work", authorGroup.value("telephone-work", "").toString());
        setAuthorInfo("fax", authorGroup.value("fax", "").toString());
        setAuthorInfo("country",authorGroup.value("country", "").toString());
        setAuthorInfo("postal-code",authorGroup.value("postal-code", "").toString());
        setAuthorInfo("city", authorGroup.value("city", "").toString());
        setAuthorInfo("street", authorGroup.value("street", "").toString());
        setAuthorInfo("position", authorGroup.value("position", "").toString());
        setAuthorInfo("company", authorGroup.value("company", "").toString());
		authorGroup.endGroup();
