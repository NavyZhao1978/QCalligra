...
QByteArray KoServiceProvider::readNativeFormatMimeType()   //static
{
	...
	return QString::fromLocal8Bit("application/vnd.oasis.opendocument.graphics").toLocal8Bit();
...
//KService::Ptr KoServiceProvider::readNativeService(const QString &componentData)
//{
