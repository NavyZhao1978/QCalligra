...
QAction *KoGridData::gridToggleAction(QWidget* canvas)
{
    if (! d->toggleGridAction) {
        d->toggleGridAction = new QAction(QIcon("view-grid"), QObject::tr("Show Grid"), 0);
        d->toggleGridAction->setToolTip(QObject::tr("Shows or hides grid"));
