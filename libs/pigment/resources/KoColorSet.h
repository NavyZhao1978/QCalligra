 ...
 * from the Gimp.
 */
class PIGMENT_EXPORT KoColorSet : public QObject, public KoResource
{
    Q_OBJECT
public:
    /**
...
public:
	...
	QString name() { return KoResource::name(); };
	void setName(const QString &str) { KoResource::setName(str); };
