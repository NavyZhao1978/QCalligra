...
class KoCompositeOpSubtract : public KoCompositeOpAlphaBase<_CSTraits, KoCompositeOpSubtract<_CSTraits>, true >
{
...
public:
    ...
    KoCompositeOpSubtract(const KoColorSpace * cs)
            : KoCompositeOpAlphaBase<_CSTraits, KoCompositeOpSubtract<_CSTraits>, true >(cs, COMPOSITE_SUBTRACT, QObject::tr("Subtract"), KoCompositeOp::categoryArithmetic()) {
    }
