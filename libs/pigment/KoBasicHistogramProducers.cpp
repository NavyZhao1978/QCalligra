...
KoGenericRGBHistogramProducer::KoGenericRGBHistogramProducer()
        : KoBasicHistogramProducer(KoID("GENRGBHISTO", QObject::tr("Generic RGB Histogram")),
                                   3, 256, 0)
{
    ...
    m_channelsList.append(new KoChannelInfo(QObject::tr("R"), 0, 0, KoChannelInfo::COLOR, KoChannelInfo::UINT8, 1, QColor(255, 0, 0)));
    m_channelsList.append(new KoChannelInfo(QObject::tr("G"), 1, 1, KoChannelInfo::COLOR, KoChannelInfo::UINT8, 1, QColor(0, 255, 0)));
    m_channelsList.append(new KoChannelInfo(QObject::tr("B"), 2, 2, KoChannelInfo::COLOR, KoChannelInfo::UINT8, 1, QColor(0, 0, 255)));
}
...
KoGenericLabHistogramProducer::KoGenericLabHistogramProducer()
        : KoBasicHistogramProducer(KoID("GENLABHISTO", QObject::tr("L*a*b* Histogram")), 3, 256, 0)
{
    /* we set 0 as colorspace, because we are not based on a specific colorspace. This
       is no problem for the superclass since we override channels() */
    m_channelsList.append(new KoChannelInfo(QObject::tr("L*"), 0, 0, KoChannelInfo::COLOR, KoChannelInfo::UINT8));
    m_channelsList.append(new KoChannelInfo(QObject::tr("a*"), 1, 1, KoChannelInfo::COLOR, KoChannelInfo::UINT8));
    m_channelsList.append(new KoChannelInfo(QObject::tr("b*"), 2, 2, KoChannelInfo::COLOR, KoChannelInfo::UINT8));
