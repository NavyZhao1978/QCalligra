...
public:
    KoGenericRGBHistogramProducerFactory()
            : KoHistogramProducerFactory(KoID("GENRGBHISTO", QObject::tr("Generic RGB Histogram"))) {}
...
public:
    KoGenericLabHistogramProducerFactory()
            : KoHistogramProducerFactory(KoID("GENLABHISTO", QObject::tr("Generic L*a*b* Histogram"))) {}
