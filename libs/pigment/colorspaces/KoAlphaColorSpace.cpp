...
public:
    ...
    CompositeClear(KoColorSpace * cs)
            : KoCompositeOp(cs, COMPOSITE_CLEAR, QObject::tr("Clear"), KoCompositeOp::categoryMix()) {
    }
...
public:
    ...
    CompositeSubtract(KoColorSpace * cs)
            : KoCompositeOp(cs, COMPOSITE_SUBTRACT, QObject::tr("Subtract"), KoCompositeOp::categoryArithmetic()) {
    }
...
public:
    ...
    CompositeMultiply(KoColorSpace * cs)
            : KoCompositeOp(cs, COMPOSITE_MULT, QObject::tr("Multiply"), KoCompositeOp::categoryArithmetic()) {
    }
...
KoAlphaColorSpace::KoAlphaColorSpace() :
        KoColorSpaceAbstract<AlphaU8Traits>("ALPHA", QObject::tr("Alpha mask"))
{
    addChannel(new KoChannelInfo(QObject::tr("Alpha"), 0, 0, KoChannelInfo::ALPHA, KoChannelInfo::UINT8));
