...
KoRgbU8ColorSpace::KoRgbU8ColorSpace() :
        ...
        KoSimpleColorSpace<KoBgrU8Traits>(colorSpaceId(),
                                          QObject::tr("RGB (8-bit integer/channel, unmanaged)"),
                                          RGBAColorModelID,
                                          Integer8BitsColorDepthID)
{
    
    addChannel(new KoChannelInfo(QObject::tr("Blue"),  0, 2, KoChannelInfo::COLOR, KoChannelInfo::UINT8, 1, QColor(0, 0, 255)));
    addChannel(new KoChannelInfo(QObject::tr("Green"), 1, 1, KoChannelInfo::COLOR, KoChannelInfo::UINT8, 1, QColor(0, 255, 0)));
    addChannel(new KoChannelInfo(QObject::tr("Red"),   2, 0, KoChannelInfo::COLOR, KoChannelInfo::UINT8, 1, QColor(255, 0, 0)));
    addChannel(new KoChannelInfo(QObject::tr("Alpha"), 3, 3, KoChannelInfo::ALPHA, KoChannelInfo::UINT8));
