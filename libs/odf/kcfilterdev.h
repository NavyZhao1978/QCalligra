...
*/
#ifndef __kofilterdev_h
#define __kofilterdev_h
 ...
 */
class KOODF_EXPORT KoFilterDev : public QIODevice
{
public:
    /**
     ...
     * If the KoFilterBase's device is not opened, it will be opened.
     */
    virtual bool open( QIODevice::OpenMode mode );
    /**
     * Close after reading or writing.
     * If the KoFilterBase's device was opened by open(), it will be closed.
     */
    virtual void close();
    ...
    /// Reimplemented to return true. KoFilterDev is a sequential QIODevice.
...
public:
     ...
     * Use KoFilterBase::findFilterByMimeType and code similar to what
     ...
     * @return a KoFilterDev that filters the original stream. Must be deleted after using
     */
...
private:
     ...
     * @param filter the KoFilterBase to use
     * @param autoDeleteFilterBase when true this object will become the
     * owner of @p filter.
     */
    explicit KoFilterDev( KoFilterBase * filter, bool autoDeleteFilterBase = false );
private:
    class Private;
    Private* const d;
};
