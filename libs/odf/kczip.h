 ...
 */
class KOODF_EXPORT KoZip : public KoArchive
{
public:
    /**
...
private:
    class KoZipPrivate;
    KoZipPrivate * const d;
};


/**
 * A KoZipFileEntry represents an file in a zip archive.
 */
class KOODF_EXPORT KoZipFileEntry : public KoArchiveFile
{
public:
    /**
     * Creates a new zip file entry. Do not call this, KoZip takes care of it.
     */
    ...
    /// Name with complete path - KoArchiveFile::name() is the filename only (no path)
...
private:
    class KoZipFileEntryPrivate;
    KoZipFileEntryPrivate * const d;
};
