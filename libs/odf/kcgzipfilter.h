...
#ifndef __kogzipfilter__h
#define __kogzipfilter__h
 ...
 * @internal
 */
class KOODF_EXPORT KoGzipFilter : public KoFilterBase
{
public:
    KoGzipFilter();
    virtual ~KoGzipFilter();
    ...
    void init(int mode, Flag flag); // for direct users of KoGzipFilter
