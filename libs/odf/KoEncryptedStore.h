...
public:
    ...
    KoEncryptedStore(QWidget *window, const QUrl &url, const QString &filename, Mode mode, const QByteArray &appIdentification);
    ~KoEncryptedStore();
...
protected:
    ...
    const KoArchiveDirectory *m_currentDir;
private:
