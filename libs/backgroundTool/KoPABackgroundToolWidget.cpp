...
, m_tool( tool )
{
    ...
    const QString useMasterBackgroundText =
        isSlideType ? QObject::tr("Use background of master slide") : QObject::tr("Use background of master page");
    widget.useMasterBackground->setText(useMasterBackgroundText);
    const QString displayMasterShapesText =
        isSlideType ? QObject::tr("Display shapes of master slide") : QObject::tr("Display shapes of master page");
    ...
    if ( !url.isEmpty() ) {
        {
            ...
            if ( !image.isNull() ) {
                ...
                const QString commandTitle = isSlideType ?
                    QObject::tr("Change slide background image") :
                    QObject::tr("Change page background image");
