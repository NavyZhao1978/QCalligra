...
#ifndef QSELECTACTION_H
#define QSELECTACTION_H
 ...
 */
class KOWIDGETS_EXPORT QSelectAction : public QAction
{
    Q_OBJECT
    ...
    Q_DECLARE_PRIVATE(QSelectAction)
...
public:
     ...
     */
    explicit QSelectAction(QObject *parent);
     ...
     *
     * This is the most common QSelectAction used when you do not have a
     ...
     * @param parent The action's parent object.
     */
    QSelectAction(const QString& text, QObject *parent);

    /**
     * Constructs a selection action with text and an icon; a shortcut may be specified by
     * the ampersand character (e.g. \"&amp;Option\" creates a shortcut with key \e O )
     *
     * This is the other common QSelectAction used.  Use it when you
     ...
     * @param parent The action's parent object.
     */
    QSelectAction(const QIcon& icon, const QString& text, QObject *parent);

    /**
     * Destructor
     */
    virtual ~QSelectAction();
...
protected:
    ...
    /**
     * @internal
     * Creates a new QSelectAction object.
     *
     * @param dd the private d member
     * @param parent The action's parent object.
     */
    QSelectAction(QSelectActionPrivate &dd, QObject *parent);

	friend class QSelectActionPrivate;
    QSelectActionPrivate *d_ptr;
...
#ifndef QSELECTACTION_P_H
#define QSELECTACTION_P_H
...
class QSelectActionPrivate
{
	friend class QSelectAction;

    Q_DECLARE_PUBLIC(QSelectAction)

public:
  QSelectActionPrivate();

  virtual ~QSelectActionPrivate();
  ...
  QSelectAction::ToolBarMode m_toolBarMode;
