    ...
    , d(new Private())
{
    ...
    d->lineWidth->setToolTip(QObject::tr("Set line width of actual selection"));
    mainLayout->addWidget(d->lineWidth, 1, 1, 1, 3);

    // The cap group
    QLabel* capLabel = new QLabel(QObject::tr("Cap:"), this);
    ...
    button->setToolTip(QObject::tr("Butt cap"));
    ...
    button->setCheckable(true);
    button->setToolTip(QObject::tr("Round cap"));
    ...
    button->setCheckable(true);
    button->setToolTip(QObject::tr("Square cap"));
    d->capGroup->addButton(button, Qt::SquareCap);
    mainLayout->addWidget(button, 2, 3, Qt::AlignLeft);

    // The join group
    QLabel* joinLabel = new QLabel(QObject::tr("Join:"), this);
    ...
    button->setCheckable(true);
    button->setToolTip(QObject::tr("Miter join"));
    ...
    button->setCheckable(true);
    button->setToolTip(QObject::tr("Round join"));
    ...
    button->setCheckable(true);
    button->setToolTip(QObject::tr("Bevel join"));
    d->joinGroup->addButton(button, Qt::BevelJoin);
    mainLayout->addWidget(button, 3, 3, Qt::AlignLeft);

    // Miter limit
    QLabel* miterLabel = new QLabel(QObject::tr("Miter limit:"), this);
    ...
    d->miterLimit->setToolTip(QObject::tr("Set miter limit"));
