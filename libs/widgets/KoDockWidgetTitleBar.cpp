...
KoDockWidgetTitleBar::KoDockWidgetTitleBar(QDockWidget* dockWidget)
        : QWidget(dockWidget), d(new KoDockWidgetTitleBarPrivate(this))
{
...
void KoDockWidgetTitleBarPrivate::toggleFloating()
{
...
void KoDockWidgetTitleBarPrivate::toggleCollapsed()
{
    QDockWidget *q = qobject_cast<QDockWidget*>(thePublic->parentWidget());
...
void KoDockWidgetTitleBarPrivate::featuresChanged(QDockWidget::DockWidgetFeatures)
{
    QDockWidget *q = qobject_cast<QDockWidget*>(thePublic->parentWidget());
