...
#ifndef QXYSELECTOR_H
#define QXYSELECTOR_H
...
/**
 * QXYSelector is the base class for other widgets which
 ...
 */
class KOWIDGETS_EXPORT QXYSelector : public QWidget
{
  Q_OBJECT
...
public:
   ...
   */
  explicit QXYSelector( QWidget *parent=0 );
  /**
