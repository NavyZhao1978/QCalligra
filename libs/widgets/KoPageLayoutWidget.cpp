...
void KoPageLayoutWidget::facingPagesChanged()
{
    ...
    if (d->widget.singleSided->isChecked()) {
        d->widget.leftLabel->setText(QObject::tr("Left Edge:"));
        d->widget.rightLabel->setText(QObject::tr("Right Edge:"));
    }
    else {
        d->widget.leftLabel->setText(QObject::tr("Binding Edge:"));
        d->widget.rightLabel->setText(QObject::tr("Page Edge:"));
    }
    d->allowSignals = true;
    marginsChanged();
...
{
    if (apply) {
        d->widget.facingPageLabel->setText(QObject::tr("Facing Pages:"));
        d->widget.facingPages->setText(QObject::tr("Facing pages"));
    }
    else {
        d->widget.facingPageLabel->setText(QObject::tr("Page Layout:"));
        d->widget.facingPages->setText(QObject::tr("Page spread"));
    }
}
