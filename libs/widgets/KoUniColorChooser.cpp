...
//    m_HIn->setFixedSize(40, 18);
    ...
    m_HIn->setToolTip( QObject::tr("Hue" ) );
    ...
    m_SIn->setToolTip( QObject::tr("Saturation" ) );
    ...
    m_VIn->setToolTip( QObject::tr("Value (brightness)" ) );
    ...
    m_RIn->setToolTip( QObject::tr("Red" ) );
    ...
    m_GIn->setToolTip( QObject::tr("Green" ) );
    ...
    m_BIn->setToolTip( QObject::tr("Blue" ) );
    ...
    if ( cmykColorSpace() ) {
        ...
        m_CIn->setToolTip( QObject::tr("Cyan" ) );
        ...
        m_MIn->setToolTip( QObject::tr("Magenta" ) );
        ...
        m_YIn->setToolTip( QObject::tr("Yellow" ) );
        ...
        m_KIn->setToolTip( QObject::tr("Black" ) );
    }
    ...
    m_LIn->setToolTip( QObject::tr("Lightness" ) );
    ...
    m_aIn->setToolTip( QObject::tr("Green to magenta*" ) );
    ...
    //m_bIn->setFixedSize(40, 18);
    m_bIn->setFocusPolicy( Qt::ClickFocus );
    m_bIn->setToolTip( QObject::tr("Blue to yellow" ) );

    if(m_showOpacitySlider)
    {
        m_opacityLabel = new QLabel(QObject::tr("Opacity:" ), this);
...
void KoUniColorChooser::doSimpleLayout()
{
    ...
    if( m_showOpacitySlider )
    {
        ...
        m_opacitySlider->setToolTip( QObject::tr("Opacity" ) );
