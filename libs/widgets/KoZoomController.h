...
public:
    ...
    */
    KoZoomController(KoCanvasController *controller, KoZoomHandler *zoomHandler, QMenu *actionCollection, KoZoomAction::SpecialButtons specialButtons = 0, QObject *parent = 0);
