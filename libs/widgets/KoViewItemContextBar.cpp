...
void KoViewItemContextBar::updateToggleSelectionButton()
{
    ...
    m_ToggleSelectionButton->setIcon(QIcon(QLatin1String(iconName)));
    m_ToggleSelectionButton->setToolTip(isHoveredIndexSelected ? QObject::tr("deselect item") : QObject::tr("select item"));
}
