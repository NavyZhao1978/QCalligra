    ...
    : QWidget( parent ), d( new Private() )
{
    ...
    button->setToolTip( QObject::tr("Import Resource") );
    ...
    button->setToolTip( QObject::tr("Delete Resource") );
    ...
    button->setToolTip( QObject::tr("Download Resource") );
    button->setEnabled( true );
    button->hide();
    ...
    button->setToolTip( QObject::tr("Share Resource") );
    button->setEnabled( false );
    button->hide();
...
void KoResourceItemChooser::slotButtonClicked( int button )
{
    if( button == Button_Import ) {
        ...
        //QString filename = QFileDialog::getOpenFileName( QUrl(), filter, 0, QObject::tr("Choose File to Add" ) );
		QString filename = QFileDialog::getOpenFileName(this
			, QObject::tr("Choose File to Add" )
			, QUrl().path()
			, filter);
