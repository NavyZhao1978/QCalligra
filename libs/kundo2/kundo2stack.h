...
public:
    ...
    QAction* createRedoAction(QActionGroup* actionCollection, const QString& actionName = QString());
    QAction* createUndoAction(QActionGroup* actionCollection, const QString& actionName = QString());
};
