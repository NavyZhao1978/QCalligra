...
class FLAKE_EXPORT KoCanvasControllerWidget : public QAbstractScrollArea, public KoCanvasController
{
    ...
    friend class KoCanvasControllerWidgetPrivate;
...
public:
     ...
     */
    explicit KoCanvasControllerWidget(QMenu * actionCollection, QWidget *parent = 0);
    ...
    KoCanvasControllerWidgetPrivate *priv();
...
private:
    ...
    KoCanvasControllerWidgetPrivate * const d;
};
