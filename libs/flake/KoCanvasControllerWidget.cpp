...
//
//class KoCanvasControllerWidgetPrivate
//{
//	friend class KoCanvasControllerWidget;
//	friend class KoCanvasController;
//public:
//
//    KoCanvasControllerWidgetPrivate(KoCanvasControllerWidget *qq)
//        : q(qq)
//        , canvas(0)
...
void KoCanvasControllerWidgetPrivate::setDocumentOffset()
{
    ...
    if (canvasWidget) {
        ...
        if (!isCanvasOpenGL) {
            ...
            if (q->canvasMode() == KoCanvasController::Spreadsheet && canvasWidget->layoutDirection() == Qt::RightToLeft) {
...
void KoCanvasControllerWidgetPrivate::resetScrollBars()
{
...
void KoCanvasControllerWidgetPrivate::emitPointerPositionChangedSignals(QEvent *event)
{
    if (!canvas) return;
...
void KoCanvasControllerWidgetPrivate::activate()
{
    QWidget *parent = q;
...
void KoCanvasControllerWidgetPrivate::unsetCanvas()
{
    QWidget *parent = q;
    while (parent->parentWidget()) {
        parent = parent->parentWidget();
...
////////////
KoCanvasControllerWidget::KoCanvasControllerWidget(QMenu * actionCollection, QWidget *parent)
    : QAbstractScrollArea(parent)
    , KoCanvasController(actionCollection)
    , d(new KoCanvasControllerWidgetPrivate(this))
{
...
KoCanvasControllerWidgetPrivate *KoCanvasControllerWidget::priv()
{
    return d;
}
