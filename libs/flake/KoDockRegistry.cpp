...
KoPluginFactory::KoPluginFactory(QObject* parent) 
	: QObject(parent)
{

}

KoPluginFactory::~KoPluginFactory()
{
...
KoPluginRegistry::KoPluginRegistry()
{
}

void KoPluginRegistry::init()
{
...
KoPluginRegistry* KoPluginRegistry::instance()
{
    K_GLOBAL_STATIC(KoPluginRegistry, s_instance)
    if (!s_instance.exists()) {
        s_instance->init();
    }
    return s_instance;
