...
KoConnectionShapeConfigWidget::KoConnectionShapeConfigWidget()
{
    ...
    widget.connectionType->addItem(koIcon("standard-connector"), QObject::tr("Standard"));
    widget.connectionType->addItem(koIcon("lines-connector"), QObject::tr("Lines"));
    widget.connectionType->addItem(koIcon("straight-connector"), QObject::tr("Straight"));
    widget.connectionType->addItem(koIcon("curve-connector"), QObject::tr("Curve"));
