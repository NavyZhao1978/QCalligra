...
QShortcut KoToolFactoryBase::shortcut() const
{
    return QShortcut(d->keysequence, 0);
}
...
void KoToolFactoryBase::setShortcut(const QShortcut & shortcut)
{
    d->keysequence = shortcut.key();
}
