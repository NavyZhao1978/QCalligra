...
QList<QWidget *> KoCreatePathTool::createOptionWidgets()
{
    ...
    layout->addWidget(new QLabel(QObject::tr("Angle snapping delta:"), angleWidget), 0, 0);
    //QDoubleSpinBox *angleEdit = new QDoubleSpinBox(d->angleSnappingDelta, angleWidget);
	QDoubleSpinBox *angleEdit = new QDoubleSpinBox(angleWidget);
    ...
    angleWidget->setWindowTitle(QObject::tr("Angle Constraints"));
