        ...
        m_temporary(false), m_zoomInMode(true)
{
	...
	inPixmap.load( QCoreApplication::applicationDirPath()+"/data"+"/calligra/icons/zoom_in_cursor.png" );
    //outPixmap.load(KStandardDirs::locate("data", "calligra/icons/zoom_out_cursor.png"));
	outPixmap.load( QCoreApplication::applicationDirPath()+"/data"+"/calligra/icons/zoom_out_cursor.png" );
